...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=area&box=150.545745,-33.675425,150.426868,-33.774239
...
[!] If you look at one height map, look at this one. [!]
  ...
  * area Height Map (SRTM3 v4.1).png
  ...
  * area Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 209m (actual) is equal to 40m in
